...
const KeyboardShortcuts = {
    ...
    setupKeyboardListeners() {
        document.addEventListener('keydown', (e) => {
            ...
            // Toggle favorites filter with 'f'
            if (e.key === 'f' || e.key === 'F') {
                e.preventDefault();
                const favBtn = document.getElementById('favoritesFilterBtn');
                if (favBtn) {
                    favBtn.click();
                    Utils.showToast('Любими ' + (Favorites?.onlyShowFavorites ? 'включени' : 'изключени'), 'info');
                }
            }
    ...
    showHelp() {
        const helpText = `
            <div style="text-align: left; line-height: 1.8;">
                ...
                <p><kbd>F</kbd> - Покажи само любими</p>
                <p><kbd>1-6</kbd> - Смени тип локация</p>

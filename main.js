...
let currentRatings = {};
let currentLocationType = "neighborhood"; // 'neighborhood', 'childcare', 'doctors', 'shops'
...
function setLocationType(type) {
    ...
    const city = (citySelectEl ? citySelectEl.value : '') || currentCity;
    ...
    const filterNeighborhoodClear = document.getElementById('filterNeighborhood');
    if (filterNeighborhoodClear) filterNeighborhoodClear.value = '';
    currentRatings = {};
...
function setupEventListeners() {
    ...
    const filterNeighborhoodMain = document.getElementById('filterNeighborhood');
    if (filterNeighborhoodMain) {
        filterNeighborhoodMain.addEventListener('change', (e) => {

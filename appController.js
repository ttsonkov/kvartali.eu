...
const AppController = {
    ...
    init() {
        ...
        // Apply split layout immediately
        ...
        } else if (hash.includes('uchilishta')) {
        ...
        if (locationType === 'childcare') {
            ...
            if (pageTitle) {
                const titleSpan = pageTitle.querySelector('span:first-child');
                if (titleSpan) titleSpan.textContent = '🎓 Училища:';
            }
            document.title = 'Училища на България - Оценки и мнения | KvartaliEU';
            ...
            if (pageTitle) {
                const titleSpan = pageTitle.querySelector('span:first-child');
                if (titleSpan) titleSpan.textContent = '🔧 Услуги:';
            }
            document.title = 'Услуги на България - Оценки и мнения | KvartaliEU';
        }

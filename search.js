 ...
 * Real-time search with fuzzy matching for neighborhoods, childcare, schools, doctors
 */
...
const Search = {
    ...
    displaySearchResults(searchResults, filters) {
        ...
        const entries = Object.entries(grouped).map(([neighborhood, neighborhoodRatings]) => {
            ...
            if (locationType === 'childcare' || locationType === 'schools' || locationType === 'doctors' || locationType === 'services') {
